...
#define ALLOC_ERROR(fmt, args...) ERROR_PRINT("alloc-custom: " fmt"\n", ##args)
#define ALLOC_DEBUG(fmt, args...) DEBUG_PRINT("alloc-custom: " fmt"\n", ##args)
#define ALLOC_INFO(fmt, args...)   INFO_PRINT("alloc-custom: " fmt"\n", ##args)
